...
pub trait TagsApi {
    ...
    async fn list_attachment_by_tag(&self, id: i32, page: Option<i32>) -> Result<crate::models::AttachmentArray, Error>;
...
impl TagsApi for TagsApiClient {
    ...
    async fn list_attachment_by_tag(&self, id: i32, page: Option<i32>) -> Result<crate::models::AttachmentArray, Error> {
        ...
        let uri_str = format!("{}/api/v1/tags/{id}/attachments", configuration.base_path, id=id);
        let mut req_builder = client.request(::reqwest::Method::GET, uri_str.as_str());
