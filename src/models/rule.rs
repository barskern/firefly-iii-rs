...
impl Rule {
    pub fn new(title: String, rule_group_id: String, trigger: crate::models::RuleTriggerType, triggers: Vec<crate::models::RuleTrigger>, actions: Vec<crate::models::RuleAction>) -> Rule {
        Rule {
            created_at: None,
            updated_at: None,
            title,
