...
pub struct WebhookAttemptSingle {
    #[serde(rename = "data")]
    pub data: crate::models::WebhookAttemptRead,
}

impl WebhookAttemptSingle {
    pub fn new(data: crate::models::WebhookAttemptRead) -> WebhookAttemptSingle {
