...
pub struct WebhookMessageArray {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::WebhookMessageRead>,
    #[serde(rename = "meta")]
    pub meta: crate::models::Meta,
}

impl WebhookMessageArray {
    pub fn new(data: Vec<crate::models::WebhookMessageRead>, meta: crate::models::Meta) -> WebhookMessageArray {
        WebhookMessageArray {
            data,
            meta: meta,
        }
