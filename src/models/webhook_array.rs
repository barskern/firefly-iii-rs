...
pub struct WebhookArray {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::WebhookRead>,
    #[serde(rename = "meta")]
...
impl WebhookArray {
    pub fn new(data: Vec<crate::models::WebhookRead>, meta: crate::models::Meta, links: crate::models::PageLink) -> WebhookArray {
        WebhookArray {
            data,
            meta: meta,
            links: links,
