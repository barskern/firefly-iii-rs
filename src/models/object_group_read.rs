...
pub struct ObjectGroupRead {
    ...
    pub attributes: crate::models::ObjectGroup,
}

impl ObjectGroupRead {
    pub fn new(_type: String, id: String, attributes: crate::models::ObjectGroup) -> ObjectGroupRead {
        ObjectGroupRead {
            _type,
            id,
