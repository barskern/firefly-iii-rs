...
pub struct ConfigurationSingle {
    #[serde(rename = "data")]
    pub data: crate::models::Configuration,
}

impl ConfigurationSingle {
    pub fn new(data: crate::models::Configuration) -> ConfigurationSingle {
        ConfigurationSingle {
            data: data,
        }
    }
