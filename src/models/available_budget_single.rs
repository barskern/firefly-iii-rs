...
pub struct AvailableBudgetSingle {
    #[serde(rename = "data")]
    pub data: crate::models::AvailableBudgetRead,
}

impl AvailableBudgetSingle {
    pub fn new(data: crate::models::AvailableBudgetRead) -> AvailableBudgetSingle {
