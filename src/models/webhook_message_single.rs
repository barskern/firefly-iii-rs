...
pub struct WebhookMessageSingle {
    #[serde(rename = "data")]
    pub data: crate::models::WebhookMessageRead,
}

impl WebhookMessageSingle {
    pub fn new(data: crate::models::WebhookMessageRead) -> WebhookMessageSingle {
