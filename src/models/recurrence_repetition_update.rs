...
pub struct RecurrenceRepetitionUpdate {
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub _type: Option<crate::models::RecurrenceRepetitionType>,
    ...
    #[serde(rename = "moment", skip_serializing_if = "Option::is_none")]
...
impl RecurrenceRepetitionUpdate {
    pub fn new() -> RecurrenceRepetitionUpdate {
