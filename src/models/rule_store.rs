...
pub struct RuleStore {
    ...
    pub trigger: crate::models::RuleTriggerType,
    ...
    pub triggers: Vec<crate::models::RuleTriggerStore>,
    #[serde(rename = "actions")]
    pub actions: Vec<crate::models::RuleActionStore>,
}

impl RuleStore {
    pub fn new(title: String, rule_group_id: String, trigger: crate::models::RuleTriggerType, triggers: Vec<crate::models::RuleTriggerStore>, actions: Vec<crate::models::RuleActionStore>) -> RuleStore {
        RuleStore {
            title,
            description: None,
            rule_group_id,
