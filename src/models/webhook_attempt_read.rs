...
pub struct WebhookAttemptRead {
    ...
    pub attributes: crate::models::WebhookAttempt,
}

impl WebhookAttemptRead {
    pub fn new(_type: String, id: String, attributes: crate::models::WebhookAttempt) -> WebhookAttemptRead {
        WebhookAttemptRead {
            _type,
            id,
